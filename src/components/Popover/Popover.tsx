...
export const Popover: FunctionComponent<BaseProps> = ({ children }) => {
  return (
        ...
        {({ open }) => (
          <>
            <HeadlessPopover.Button
              className={`group inline-flex items-center rounded-md bg-orange-700 px-3 py-2 text-base font-medium hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75`}
            >
              <p>Solutions</p>
              <ChevronDownIcon
